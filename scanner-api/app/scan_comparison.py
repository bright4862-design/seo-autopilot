...
def build_customer_scan_comparison_presentation(comparison: dict[str, Any]) -> dict[str, Any]:
    ...
    sample_line = f"Pages checked: {previous_pages} in the previous scan; {current_pages} in this scan."
    if sample_changed:
        caution = (
            "These scans checked different numbers of pages. The score change alone cannot tell you "
            "whether your site improved or got worse. Repair comparisons use the evidence available from both scans."
        )
    else:
        caution = (
            "These scans checked the same number of pages, but may have checked different pages. "
            "The score change alone cannot tell you whether your site improved or got worse. "
            "Repair comparisons use the evidence available from both scans."
        )
