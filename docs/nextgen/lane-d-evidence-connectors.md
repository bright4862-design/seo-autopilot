...
- GA4 property identities must be numeric (`properties/<id>` or bare numeric import form), and landing-page evidence must be root-relative; `(not set)` remains explicit unknown identity.
