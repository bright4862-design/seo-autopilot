from app.artifact_filter import ARTIFACT_FILTER_VERSION, MAX_ARTIFACT_EVIDENCE, is_artifact_url, record_artifact
...
def test_human_blog_slugs_are_not_artifacts():
    assert ARTIFACT_FILTER_VERSION == "artifact_filter_v2_human_slug_safe"
