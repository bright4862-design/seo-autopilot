...
from .v2 import AIAnnotationV2, ChatAnswerV2, NumericClaimV2, StateClaimV2
...
SCHEMA_REGISTRY: dict[str, type[BaseModel]] = {
    ...
    "ai_annotation_v2": AIAnnotationV2,
    "chat_answer_v2": ChatAnswerV2,
}
...
__all__ = [
    "AIAnnotationV2", "ChatAnswerV2", "NumericClaimV2", "StateClaimV2",
    "AIAnnotationV1",
    "ChatAnswerV1",
    "EvidenceRefV1",
    "NumericClaimV1",
