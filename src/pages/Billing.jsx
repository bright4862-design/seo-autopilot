...
const plans = [
  { id: "standard_150", name: "Standard 150", price: "$100 one-time", desc: "Lifetime access to the production Standard 150 scanner.", features: ["Unlimited Standard 150 scans", "Complete FixList", "Plain-English recommendations"] },
