...
const CURRENT_ARCHETYPE_CLASSIFIER_VERSION = "archetype_classifier_v7_html_route_app_distribution";
...
const CURRENT_BETA_REVISION_FINGERPRINT = "561db6e131da53a9";
