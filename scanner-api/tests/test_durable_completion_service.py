...
def test_worker_uses_only_signed_hosted_boundaries():
    ...
    assert 'invoke_function(client, "persistDurableScanAuthorityV7", envelope)' in source
    assert 'invoke_function(client, "durableScanWorkerControlV7", envelope' in source
