...
| | |
|---|---|
| Candidate fingerprint | `ce7d7ecc4f508332` |
...
`archetype_classifier_v8_platform_product_routes`. The corrective candidate code is
fingerprint `ce7d7ecc4f508332` with classifier
...
The immediately preceding deployed canary was `c73399086107cbaf`. Its Bay Management
Group customer scan passed operationally but **did not pass report-quality acceptance**:
a specific top-level landing URL collapsing to the homepage was called usable, the
150-page sample overrepresented the blog section, and redirect evidence URLs were not
clickable. The `ce7d7ecc4f508332` candidate addresses only those three observed defects;
it remains a candidate until a fresh production Bay scan proves them end to end.

Before `c73399086107cbaf`, the superseded candidate was `053180f4bdc70857`; before that `821d211419fd327e`; before that `cc385c397c97d579`, `b3345916049979a1`, `77588ce93276d608`, `68a16802a9c7a543`, `a43a71c61f32d9fb`, `2f4238b4989f3fd9`, `0544ce395811cbd5`,
...
The preceding `c73399086107cbaf` candidate moved the fingerprint by extending the signed
