...
os.environ.setdefault("SCAN_TASKS_QUEUE_PATH", "projects/seo-autopilot-501517/locations/europe-west1/queues/fixlist-standard150")
os.environ.setdefault("SCAN_WORKER_URL", "https://fixlist-standard150-worker-tpucgyfewa-ew.a.run.app/scan-job")
os.environ.setdefault("TASKS_INVOKER_SERVICE_ACCOUNT", "fixlist-standard150-invoker@seo-autopilot-501517.iam.gserviceaccount.com")
...
def task(*, scan_id="scan123", drain=False):
    ...
    body = {"scan_id": scan_id, "request_id": "req123"}
    if drain:
