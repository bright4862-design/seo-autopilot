...
export const MOCK_ISSUES = [
  { page_url: "/services", category: "meta_title", priority: "high", status: "auto_fixed", issue_title: "Missing page title on Services page", plain_english_explanation: "Your Services page didn't have a unique title tag. We generated one based on your business name and services.", why_it_matters: "Page titles are the first thing people see in Google search results. Without one, Google makes up its own — and it's usually not great.", current_value: "(empty)", recommended_value: "Plumbing & HVAC Services | Sunshine Plumbing Denver", ai_recommendation: "We auto-generated a title using your business name, location, and main services.", confidence_score: 92, can_auto_fix: true, requires_approval: false, requires_developer: false },
  { page_url: "/about", category: "meta_description", priority: "medium", status: "needs_approval", issue_title: "Missing meta description on About page", plain_english_explanation: "Your About page doesn't have a meta description. This is the short summary that shows under your page title in Google.", why_it_matters: "A good meta description convinces people to click your result instead of a competitor's.", current_value: "(empty)", recommended_value: "Sunshine Plumbing & Heating has served the Denver metro area for 15+ years. Licensed, insured, and ready to help with plumbing & HVAC.", ai_recommendation: "We wrote a description highlighting your experience and service area.", confidence_score: 85, can_auto_fix: false, requires_approval: true, requires_developer: false },
  ...
  { page_url: "/water-heater-repair", category: "canonical", priority: "medium", status: "needs_approval", issue_title: "Canonical tag points to a different URL version", plain_english_explanation: "This page's canonical tag points to a URL with a trailing slash, but the actual URL doesn't have one. This confuses Google about which version is the 'real' page.", why_it_matters: "When Google sees two versions of the same page, it may split your ranking power between them.", current_value: "https://sunshineplumbing.com/water-heater-repair/", recommended_value: "https://sunshineplumbing.com/water-heater-repair", ai_recommendation: "Update the canonical tag to match the actual URL without trailing slash.", confidence_score: 95, can_auto_fix: false, requires_approval: true, requires_developer: false },
...
export const MOCK_DEV_RECOMMENDATIONS = [
  ...
  { title: "Add LocalBusiness schema markup", description: "Add structured data to your site so Google can show your business info (hours, phone, address) directly in search results.", category: "technical_seo", priority: "high", business_impact: "Schema markup can increase click-through rates by 20-30% by showing rich results in Google.", estimated_complexity: "simple", recommended_package: "diy", status: "open" },
  { title: "Fix JavaScript-rendered navigation", description: "Your main navigation menu loads via JavaScript. This means Google might not see all your pages when crawling.", category: "technical_seo", priority: "high", business_impact: "If Google can't find your pages through navigation, they may not get indexed at all.", estimated_complexity: "complex", recommended_package: "custom_rebuild", status: "open" },
